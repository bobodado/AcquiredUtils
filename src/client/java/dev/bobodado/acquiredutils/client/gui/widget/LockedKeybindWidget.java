...
public class LockedKeybindWidget extends AbstractWidget {
    ...
    public static class ListenerSlot {
        public LockedKeybindWidget current;
    }
    ...
    public LockedKeybindWidget(int x, int y, int width, int height, Component label, ListenerSlot slot,
